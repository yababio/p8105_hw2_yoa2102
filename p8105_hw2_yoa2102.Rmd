...
However, it is important to note that these data are NOT tidy. The route1:route11 variables make the dataset uneccessarily wide, and generate a large number of NAs. In order to optimize the dataset, it would be best to reformat these variables as observations within a new variable.  
